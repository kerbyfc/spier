...
(function() {
  ...
  Dir = (function() {
    ...
    Dir.prototype.invoke = function() {
      ...
      if ((tmp = this[event].apply(this, data))) {
        return (_ref = Watcher.prototype)[event].apply(_ref, tmp);
      }
    };
    ...
    Dir.prototype.watch = function(dir) {
      ...
      if (subdirs.length > 0) {
        ...
        for (_l = 0, _len3 = subdirs.length; _l < _len3; _l++) {
          subdir = subdirs[_l];
          _results.push(subdir.watch(File.prototype["new"](subdir.path).read()));
        }
        return _results;
      }
    };
  ...
  Watcher = (function() {
    ...
    Watcher.prototype.delay = 50;

    Watcher.prototype.pause = false;
    ...
    Watcher.prototype.on = function(event, handler) {
      var _this = this;
      Watcher.prototype[event] = function() {
        if (_this.step !== 0) {
